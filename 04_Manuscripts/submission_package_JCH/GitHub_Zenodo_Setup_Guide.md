# GitHub / Zenodo 設定手順書
# NDB_XXX_slope_diabetes — JCH 投稿版
# 作成日: 2026-06-28
...
[Author 1], [Author 2]. Association between Topographic Slope, Urban Walkability, and
...
Claims (NDB) Open Data for fiscal year 2021.
...
- **NDB Open Data No.10 (FY2021):** https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000177182.html
...
**研究概要:** 日本全47都道府県を対象に、地形傾斜・都市ウォーカビリティと糖尿病管理指標（HbA1c・BMI肥満率・腹囲・中性脂肪）の関連を生態学的研究で分析しました。NDBオープンデータNo.10（2021年度）を使用し、OLS回帰と条件付き空間ラグモデルを適用しています。
...
| Description | Analysis code and result figures for the ecological study of slope, walkability, and diabetes across 47 Japanese prefectures. Uses NDB Open Data No.10 (FY2021). |
